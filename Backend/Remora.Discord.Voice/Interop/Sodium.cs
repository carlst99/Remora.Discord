...
namespace Remora.Discord.Voice.Interop
{
    ...
    public sealed unsafe partial class Sodium
    {
        ...
        [DllImport(SodiumLibraryName, EntryPoint = "sodium_init", CallingConvention = CallingConvention.Cdecl)]
        private static extern int _SodiumInit();

        [DllImport(SodiumLibraryName, EntryPoint = "sodium_version_string", CallingConvention = CallingConvention.Cdecl)]
        private static extern byte* _SodiumVersionString();

        [DllImport(SodiumLibraryName, EntryPoint = "crypto_secretbox_xsalsa20poly1305_keybytes", CallingConvention = CallingConvention.Cdecl)]
        private static extern uint _CryptoSecretboxXsalsa20poly1305Keybytes();

        [DllImport(SodiumLibraryName, EntryPoint = "crypto_secretbox_xsalsa20poly1305_noncebytes", CallingConvention = CallingConvention.Cdecl)]
        private static extern uint _CryptoSecretboxXsalsa20poly1305Noncebytes();

        [DllImport(SodiumLibraryName, EntryPoint = "crypto_secretbox_xsalsa20poly1305_macbytes", CallingConvention = CallingConvention.Cdecl)]
        private static extern uint _CryptoSecretboxXsalsa20poly1305Macbytes();
        ...
        [DllImport(SodiumLibraryName, EntryPoint = "crypto_secretbox_easy", CallingConvention = CallingConvention.Cdecl)]
        private static extern int CryptoSecretboxEasy(byte* output, byte* message, ulong messageLength, byte* nonce, byte* key);
        ...
        [DllImport(SodiumLibraryName, EntryPoint = "randombytes_buf", CallingConvention = CallingConvention.Cdecl)]
        private static extern void RandombytesBuf(byte* buffer, int size);
    }
    ...
    public sealed unsafe partial class Sodium
    {
        ...
        /// </summary>
        public static readonly string? Version = Marshal.PtrToStringAnsi((IntPtr)_SodiumVersionString());

        /// <summary>
        /// Gets the size of the key expected by the xsalsa20_poly1305 algorithm.
        /// </summary>
        public static readonly uint KeySize = _CryptoSecretboxXsalsa20poly1305Keybytes();

        /// <summary>
        /// Gets the size of nonce expected by the xsalsa20_poly1305 algorithm.
        /// </summary>
        public static readonly uint NonceSize = _CryptoSecretboxXsalsa20poly1305Noncebytes();

        /// <summary>
        /// Gets the size of MAC generated by the xsalsa20_poly1305 algorithm.
        /// </summary>
        public static readonly uint MacSize = _CryptoSecretboxXsalsa20poly1305Macbytes();
        ...
        public static void GenerateRandomBytes(Span<byte> buffer)
        {
            ...
            {
                RandombytesBuf(bufferPtr, buffer.Length);
            }
        }
            ...
            fixed (byte* messagePtr = message)
            {
                fixed (byte* outputPtr = outputBuffer)
                {
                    fixed (byte* noncePtr = nonce)
                    {
                        ...
                        {
                            result = CryptoSecretboxEasy(outputPtr, messagePtr, (ulong)message.Length, noncePtr, keyPtr) == 0;
                        }
                    }
                }
            }
