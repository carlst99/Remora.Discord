...
namespace Remora.Discord.Voice.Responders
{
    ...
    /// </summary>
    internal sealed class VoiceStateUpdateResponder : IResponder<IVoiceStateUpdate>
    {
        ...
        {
            return await _connectionService.SubmitVoiceStateUpdate(gatewayEvent, ct).ConfigureAwait(false);
        }
    }
}
