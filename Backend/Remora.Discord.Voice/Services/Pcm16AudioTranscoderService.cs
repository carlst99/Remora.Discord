...
namespace Remora.Discord.Voice.Services
{
    ...
    public class Pcm16AudioTranscoderService : IAudioTranscoderService, IDisposable
    {
        ...
        public Pcm16AudioTranscoderService()
        {
            ...
            SampleSize = Pcm16Util.CalculateSampleSize(SampleDurationMS);
        }
        ...
        public Task<Result<int>> DecodeAsync(ReadOnlyMemory<byte> opusInput, Memory<byte> sample, CancellationToken ct = default)
        {
